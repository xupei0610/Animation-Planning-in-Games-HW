#ifndef PX_CG_ITEM_SPHERE_HPP
#define PX_CG_ITEM_SPHERE_HPP
...
class px::item::Sphere : public Item, public Rigid
{
private:
...
public:
    ...
    Sphere(glm::vec3 const &position = glm::vec3(0.f, 0.f, 0.f),
