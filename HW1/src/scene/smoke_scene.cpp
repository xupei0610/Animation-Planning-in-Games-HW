...
class scene::SmokeScene::CurlNoiseParticleSystem::impl
{
public:
...
scene::SmokeScene::CurlNoiseParticleSystem::CurlNoiseParticleSystem()
        : ParticleSystem()
{
...
void scene::SmokeScene::CurlNoiseParticleSystem::init(float *, unsigned int v_count,
...
void scene::SmokeScene::CurlNoiseParticleSystem::restart()
{
...
void scene::SmokeScene::CurlNoiseParticleSystem::upload()
{
...
void scene::SmokeScene::CurlNoiseParticleSystem::update(float dt, glm::vec3 *cam_pos)
{
...
void scene::SmokeScene::CurlNoiseParticleSystem::render(GLenum gl_draw_mode)
{
...
unsigned int const &scene::SmokeScene::CurlNoiseParticleSystem::count() const noexcept
{
    return n_particles;
}
unsigned int scene::SmokeScene::CurlNoiseParticleSystem::total() const noexcept
{
    return pimpl->tot;
}

scene::SmokeScene::SmokeScene()
        : BaseScene(),
          particle_system(nullptr),
          system_name("Smoke Simulation using Curl Noise"),
...
void scene::SmokeScene::init(Scene &scene)
{
    particle_system->init(nullptr, 0);
}

void scene::SmokeScene::restart(Scene &scene)
{
    resetCamera();
...
void scene::SmokeScene::upload(Shader &scene_shader)
{
    glClearColor(0.f, 0.f, 0.f, 1.f);
    particle_system->upload();
}

void scene::SmokeScene::render(Shader &scene_shader)
{}

void scene::SmokeScene::update(float dt)
{
    if (!pause)
...
void scene::SmokeScene::resetCamera()
{
...
void scene::SmokeScene::renderInfo()
{
...
void scene::SmokeScene::processInput(float dt)
{
