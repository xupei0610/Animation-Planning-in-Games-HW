...
public:
    ...
    virtual void scale(glm::vec3 const &scal) { _scale = scal; }
    virtual void zoom(glm::vec3 const &scal) { _scale *= scal; }
...
public:
    ...
    float const &mass() const { return _mass; }

    void velocity(glm::vec3 const &v) { velocity() = v; }
    glm::vec3 const &velocity() const { return _velocity; }

    void acceleration(glm::vec3 const &a) { acceleration() = a; }
    glm::vec3 const &acceleration() const { return _acceleration; }

    void resistance(glm::vec3 const &f) { resistance() = glm::abs(f); }
    glm::vec3 const &resistance() const { return _resistance; }
